...
- **Spring service** (wallet-service): HTTP/protobuf/4318. Configured via `MANAGEMENT_OTLP_TRACING_ENDPOINT=http://otel-collector:4318/v1/traces` and `MANAGEMENT_TRACING_SAMPLING_PROBABILITY=1.0`.
